...
public enum MemberErrorCode implements BaseErrorCode {
    ...
    REVIEW_PERMISSION_DENIED(HttpStatus.INTERNAL_SERVER_ERROR, "MEMBER_009", "담당자만 리뷰 권한이 있습니다."),
    ...
    MANAGER_PERMISSION_DENIED(HttpStatus.INTERNAL_SERVER_ERROR, "MEMBER_013", "담당자 권한이 없는 부서입니다."),
            ;
