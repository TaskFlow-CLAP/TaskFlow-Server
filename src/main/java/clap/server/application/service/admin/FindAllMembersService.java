...
import clap.server.application.mapper.response.AdminResponseMapper;
...
public class FindAllMembersService implements FindAllMembersUsecase {
    ...
    public PageResponse<RetrieveAllMemberResponse> findAllMembers(Pageable pageable) {
        ...
        return PageResponse.from(members.map(AdminResponseMapper::toRetrieveAllMemberResponse));
    }
}
